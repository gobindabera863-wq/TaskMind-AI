...
const StatsCard = ({ title, value, icon, subtext, color = "indigo", onClick, isActive = false }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`bg-gradient-to-br ${colorClasses[color]} border backdrop-blur-xl rounded-2xl p-5 shadow-xl flex items-center justify-between transition-all duration-200 ${
